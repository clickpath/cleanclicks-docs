...
description: "Triggers define what counts as a conversion on your website. When a visitor performs an action that matches a trigger rule, CleanClicks fires a conver"
---
...
**Next:** [Traffic Filters](/traffic-filters)
