...
description: "Connect Meta to CleanClicks using a System User Access Token to send conversion events via the Conversions API."
---
...
**Next:** [TikTok](/connections/tiktok)
