...
GA4 is an analytics-layer connection (Signal and up) and does not count against your ad-platform connection limit.

> **About this GA4 property:** CleanClicks uses a dedicated GA4 property, provisioned and operated by CleanClicks on your behalf under service-provider terms, for first-party server-side measurement. It is separate from your own primary GA4 property — your existing GA4 setup keeps running untouched, and CleanClicks never writes into your primary property.
