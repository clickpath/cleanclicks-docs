...
- **LinkedIn / Microsoft Ads:** Handled via the platform's own measurement restrictions
...
Conversion data is processed globally across CleanClicks infrastructure. If your business requires data to remain in a specific geographic region, contact [support@cleanclicks.io](mailto:support@cleanclicks.io) to discuss options.
...
To request data export or deletion, contact [support@cleanclicks.io](mailto:support@cleanclicks.io). Account data (profile, configuration) can be exported or deleted on request.
