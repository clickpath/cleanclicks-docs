...
description: "Install the CleanClicks JavaScript tag on your website to capture sessions, click IDs, UTM parameters, and conversion events."
---
...
Shopify uses a Custom Pixel, which has its own setup flow. See [Shopify Setup](/setup/shopify-setup) for the full guide.

### WordPress

WordPress uses a dedicated plugin. See [WordPress Setup](/setup/wordpress-setup) for the full guide.
...
**Next:** [Verifying Installation](/setup/verifying-installation)
