...
import { Card, CardGroup, Steps, Step, Tabs, Tab, Note, Warning, Info, Check } from "@mintlify/components";
...
<Info>If you're a WordPress customer and `wp_get_consent('statistics')` returns `undefined`, [contact support](mailto:helpdesk@cleanclicks.io) — the bridge may not be loading.</Info>
