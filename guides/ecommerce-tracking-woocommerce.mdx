...
description: "Set up end-to-end WooCommerce ecommerce tracking with CleanClicks using the WordPress plugin (v1.6.1), three-layer server-side conversion capture, and analytics proxies."
---
...
- CleanClicks account on **any plan** (analytics proxies require Signal+; conversion tracking + WooCommerce events work on any plan)
